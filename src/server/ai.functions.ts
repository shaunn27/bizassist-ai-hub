...
import { DEFAULT_MODEL, requireApiKey, callDeepSeekChat, DEEPSEEK_BASE_URL, readApiError } from "./ai.functions.shared";
...
// generateBusinessReport and generateInvoice moved to report.functions.ts and invoice.functions.ts
